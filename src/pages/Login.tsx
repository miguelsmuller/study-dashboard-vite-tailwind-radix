          ...
          <div className="flex flex-col overflow-y-auto md:flex-row">
            <div className="h-32 md:h-auto md:w-1/2">
              <img
                ...
                alt=""
                src="https://images.unsplash.com/photo-1488998427799-e3362cec87c3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80"
              />
            </div>
            ...
            <div className="flex items-center justify-center px-6 py-4 sm:p-8 md:w-1/2">
              <div className="w-full">
                ...
                <form action="/" className="">
                  <div className="py-2">
                    <div>
                      <label className="block text-sm font-bold text-left">
                        Username
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="flex flex-col space-y-2 mt-6">
                      <a
                        href="/"
                        className="w-full text-center py-2 rounded text-sm font-medium border-transparent bg-gray-900 text-white hover:bg-gray-600 focus:bg-gray-600 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600"
                      >
                        Sign-in
                      </a>
                      <a
                        href="/register"
                        className="w-full text-center py-2 rounded text-sm font-medium border-transparent bg-gray-200 text-gray-700 hover:bg-gray-200 focus:bg-gray-300 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
                      >
                  ...
                  <div className="flex space-x-4 py-2">
                    <a
                      href="/"
                      className="flex-1 flex items-center justify-center rounded border py-2 text-gray-600 border-gray-300 focus:bg-white focus:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-300"
                    >
                      <svg
                        className="w-11 h-5"
                        fill="#4B5563"
